...
const std::vector<const char*> GuiRenderSettings::renderTypeLabels = { "Default", "Texture", "Vertex Color", "Diffuse", "(.obj Normals) Face Direction", "(calc Normals) Face Direction", "World Normals"};
