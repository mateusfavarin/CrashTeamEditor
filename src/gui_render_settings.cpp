...
bool GuiRenderSettings::filterActive = false;
Color GuiRenderSettings::filterColor = Color(static_cast<unsigned char>(255), static_cast<unsigned char>(128), static_cast<unsigned char>(0));
